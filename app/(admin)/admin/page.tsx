        ...
        <div className="bg-white border border-stone-200 p-6">
          ...
          <div className="space-y-3">
            <Link
              ...
              className="block p-4 border border-stone-100 hover:border-gold-300 hover:bg-gold-50/50 transition-colors"
            >
          ...
          <div className="space-y-3 text-sm text-stone-600">
            <div className="flex gap-3 items-start">
              ...
              <p>
                ...
                (e.g., Women&apos;s Wear, Men&apos;s Wear, etc.)
              </p>
            </div>
            <div className="flex gap-3 items-start">
              <span className="w-6 h-6 bg-gold-100 text-gold-700 flex items-center justify-center text-xs font-medium shrink-0">
              ...
              <p>
                Add <strong>products</strong> with images, descriptions, and
                pricing
              </p>
            </div>
            <div className="flex gap-3 items-start">
              ...
              <p>
                Upload images to the <strong>gallery</strong> to showcase your
                work
              </p>
            </div>
            <div className="flex gap-3 items-start">
              ...
              <p>
                Manage client <strong>reviews</strong> and{" "}
                <strong>messages</strong> as they come in
              </p>
            </div>
          </div>
        </div>
